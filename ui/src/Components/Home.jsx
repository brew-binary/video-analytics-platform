              ...
              <div className="hero-inner">
                <div className="hero-copy">
                  <h1 className="hero-title mt-0">
                    Convert Videos and Images with Ease
                  </h1>
              ...
              <div className="newsletter-inner section-inner">
                <div className="newsletter-header text-center">
                  ...
                  <p className="section-paragraph">
                    Get Early Access to the Ultimate Media Conversion Platform:
                    Join our waitlist today and be the first to experience the
                    power of effortless image and video format conversion.
                  </p>
                </div>
