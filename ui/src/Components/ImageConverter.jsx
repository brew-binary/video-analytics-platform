...
const ImageConverter = () => {
  ...
  useEffect(() => {
    console.log(
      "From use effect: New value of imageConverted : ",
      imageConverted
    );
  }, [imageConverted]);
  ...
  const DownloadFile = async () => {
    ...
    downloadLink.href = `http://localhost:8006/download_image?filename=${downloadFileName}`;
      ...
      <>
        ...
        <div className="body-wrap boxed-container" style={{ zIndex: 0 }}>
          <header>
            ...
            <div
              className="header-shape header-shape-2"
              style={{ display: "none" }}
            >
              <svg
                width={128}
            ...
            <div>
              ...
              >
                <div className="brand header-brand">
                  <h1 className="m-0">
                    <a href="#">
                      ...
                      <defs>
                        ...
                        >
                          <stop stopColor="#FF3058" offset="0%">
                            <stop stopColor="#FF6381" offset="100%"></stop>
                          </stop>
                        </linearGradient>
                        <linearGradient
                          x1="32.716%"
                  ...
                  {/* <h1 style="color:blue;"><u>Videoanalytics.usln.in</u></h1> */}
                </div>
              </div>
            </div>
          </header>
                ...
                <div className="hero-inner">
                  <div className="hero-copy">
                    <h1 className="hero-title mt-0">
                      Convert Images in a click!!
                    </h1>
                    <p className="hero-paragraph">
                      Welcome to our video and image format converter! Our
                      online tool empowers you to convert videos and images
                      effortlessly
                    </p>
                    <ImageConverterForm
                      imageConverted={imageConverted}
                      setImageConverted={setImageConverted}
